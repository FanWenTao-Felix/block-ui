...
<style scoped>
.themes{background: url(theme.png) no-repeat;background-size:100% 100%;position:fixed;top:0;right:0;left:0;bottom:0;font-family:"Microsoft YaHei";font-size:12px;}
