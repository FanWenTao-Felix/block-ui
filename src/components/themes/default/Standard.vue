...
<style scoped>
    ...
    >>> .el-menu--horizontal > .el-submenu.is-active .el-submenu__title {
        ...
        border-bottom: 2px solid #6fc0fc;
    }
    ...
    .el-menu-vertical-demo >>> .el-menu-item.is-active:hover {
        background: rgba(0, 0, 0, 0.3);
    }
    ...
    .el-menu-vertical-demo > .el-menu-item:not(.is-disabled):hover, .el-menu-vertical-demo > .el-menu-item:not(.is-disabled):focus {
        background: rgba(0, 0, 0, 0.1);
    }
</style>
